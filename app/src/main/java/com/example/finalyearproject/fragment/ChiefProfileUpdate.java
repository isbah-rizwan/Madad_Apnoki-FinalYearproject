...
import com.example.finalyearproject.ChooseUser;
...
public class ChiefProfileUpdate extends Fragment {
    ...
    String name, email, contact, cnic, account;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_chief_profile_update, container, false);
        ...
        Contact = view.findViewById(R.id.scontact);
        Email = view.findViewById(R.id.semail);
        CNIC = view.findViewById(R.id.scnic);
        Account = view.findViewById(R.id.sdetails);
